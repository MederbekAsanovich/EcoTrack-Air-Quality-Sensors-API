...
Here are some screenshots demonstrating key aspects of the task:

### 1. Creating a New Sensor

![Screenshot 1](screenshots/create_sensor.png)  
A screenshot showing a successful `POST` request to create a new air quality sensor.

### 2. Fetching Sensor Data

![Screenshot 2](screenshots/get_sensors.png)  
A screenshot showing the output of a `GET` request fetching all air quality sensors.

### 3. Swagger API Documentation

![Screenshot 3](screenshots/swagger_ui.png)  
A screenshot of the API documentation generated by Swagger, showing the available API endpoints and their descriptions.

---

## Video Description

For a detailed walkthrough of the project, including how to interact with the API and the code implementation, watch the video demonstration here:

[Watch the Video on YouTube](https://youtube.com/your-video-link) *(Replace this link with your actual video link)*
